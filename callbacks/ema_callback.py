...
class EMAModelCheckpoint(ModelCheckpoint):
    ...
    def _save_checkpoint(self, trainer: "pl.Trainer", filepath: str) -> None:
        """
        Save a checkpoint to the given filepath.
        If an EMA callback exists, also save a separate checkpoint with EMA weights.
        """
    ...
    def _ema_format_filepath(self, filepath: str) -> str:
        """
        Generate the filename for the EMA checkpoint by adding '-EMA' before the file extension.
        """
    ...
    def _update_best_and_save(
        ...
        """
        Update top-k tracking and save the checkpoint.
        Also deletes old checkpoints beyond top-k, including the corresponding EMA files.
        """
